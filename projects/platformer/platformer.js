$(function () {
  ...
  function setup() {
    ...
    createPlatform(200,250,250,650)
    createPlatform(100,600,50,50)
    createPlatform(60,650,50,50)
    createPlatform(150,500,50,50)
    createPlatform(100,550,50,50)
    createPlatform(0,400,50,50)
    createPlatform(150,250,90,70)
    createPlatform(10,500,50,50)
    createPlatform(80,290,50,10)
    createPlatform(600,350,100,10)
    createPlatform(720,500,100,10)
    createPlatform(800,350,100,10)
    createPlatform(900,250,500,100)
    ...
    createCollectable("diamond", 80, 80, 0, 10)
    createCollectable("grace", 60, 600, 0, 0)
    createCollectable("kennedi", 810, 610, 0, 700)
    createCollectable("max", 900, 500, 100, 100)
